    ...
    if (
        ...
        if employee and work_info is not None:
            ...
            if latest_checkin:
                ...
                elapsed_seconds = 0
            print("clock_in_out.py attendance_activities",attendance_activities)
            print("latest_activity",latest_checkin)
            # for a in attendance_activities.filter(employee_id=employee).order_by('-clock_in')[:5]:
            #     print(a, a.clock_in)
            ...
            if time_runner_enabled:
                ...
                <script>
                        ...
                        sessionStorage.setItem('runInterval', "true")
                        console.log("2")
                    </script>
                    """.format(
