...
def payroll_calculation(employee, start_date, end_date):
    ...
    print("House:", housing_allowance, "| Transport:", transport_allowance, "| Other:", other_allowance)
    ...
    for ps in payslips:
        ...
        def extract_allowances(obj):
            ...
            if isinstance(obj, list):
                ...
                if amount:
                    if any(x in name for x in ["house", "housing", "hra", "rent"]):
        ...
        export_rows.append({
            ...
            "Gross Pay": gross_pay,
            "Net Pay": net_pay,
            "Housing Allowance": round(housing_allowance, 2),
